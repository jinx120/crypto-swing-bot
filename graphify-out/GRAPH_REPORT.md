...
## Corpus Check
- 118 files · ~63,700 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1190 nodes · 2353 edges · 65 communities (58 shown, 7 thin omitted)
- Extraction: 66% EXTRACTED · 34% INFERRED · 0% AMBIGUOUS · INFERRED: 794 edges (avg confidence: 0.56)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `d3415d74`
...
1. `StrategyProfile` - 83 edges
2. `MarketContext` - 77 edges
3. `Trade` - 40 edges
...
Cohesion: 0.05
Nodes (71): Position, Process one bar after entry. Returns a Trade if the position exited., CredentialStore, AlpacaData, Alpaca crypto market data. Implements the MarketDataProvider protocol., Enum, ProfileStore, RegimeResult (+63 more)

### Community 1 - "Community 1"
Cohesion: 0.10
Nodes (18): MarketContext, SignalResult, float, MarketContext, SignalResult, bool, float, int (+10 more)

### Community 2 - "Community 2"
Cohesion: 0.16
Nodes (14): bars_to_df(), fetch_window_days(), parse_timeframe(), Days to fetch so `lookback` bars at `timeframe` are comfortably covered     (~3x, DataFrame, float, int, str (+6 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (64): Backtest broker: models long-only bracket fills with fees + slippage.      Exit, SimulatedBroker, KronosForecastSignal, Kronos-based forecast signal. Satisfies the Signal protocol.      In tests, inje, DataFrame, float, int, Metrics (+56 more)
...
Cohesion: 0.10
Nodes (33): datetime, ExitReason, float, bracket_levels(), exit_decision(), Return (stop_price, take_profit_price) for a long position., Decide whether a long position exits, and a reference exit price.      Priority:, test_live_spot_price_stop() (+25 more)
...
Cohesion: 0.05
Nodes (38): AlpacaData, CandleStore, Connection, MarketData, Bar interval in seconds for a timeframe like '15m', '4h', '1d'., Serves candles from the CandleStore, fetching + caching from Alpaca on a     cac, Force a live fetch from Alpaca and upsert into the store., Return up to `limit` bars (oldest-first). If the store is empty or the         n (+30 more)
...
Cohesion: 0.23
Nodes (13): ConfluenceResult, Signal, Signal, FvgSignal, Fair Value Gap signal. Interface only in Phase 1; returns neutral 0.      Implem, OversoldSignal, RelativeStrengthSignal, VwapSignal (+5 more)
...
Cohesion: 0.18
Nodes (10): Execute predictor.predict() in a thread; return None on timeout or error., Return forecast DataFrame, or None if inference fails/times out., Execute predictor.predict() in a thread; return None on timeout or error., Return forecast DataFrame, or None if inference fails/times out., bool, DataFrame, float, int (+2 more)
...
Cohesion: 0.15
Nodes (13): KronosAdapter, _load_kronos(), PredictorProtocol, Populate the precomputed forecast cache (used by run_backtest)., Matches the real KronosPredictor.predict() signature., Lazy import gate — only called from KronosAdapter.from_profile().      Kronos is, Wraps a PredictorProtocol: column mapping, single-entry cache, timeout., Wraps a PredictorProtocol: column extraction, Series timestamps, cache, timeout. (+5 more)
...
Cohesion: 0.36
Nodes (8): Trade, compute_metrics(), test_journal_records_and_lists(), test_metrics_empty(), test_metrics_on_known_trades(), test_profit_factor_infinite_when_all_wins(), test_profit_factor_zero_when_all_losses(), _trade()
...
Cohesion: 0.43
Nodes (7): BaseModel, ActiveBody, BacktestBody, BuildBody, CredBody, ModeBody, ProfileBody
...
## Knowledge Gaps
- **240 isolated node(s):** `str`, `str`, `EntrySignal`, `float`, `float` (+235 more)
...
- **Why does `StrategyProfile` connect `Community 0` to `Community 4`, `Community 5`, `Community 6`, `Community 41`, `Community 11`, `Community 14`, `Community 17`, `Community 18`, `Community 20`?**
  _High betweenness centrality (0.159) - this node is a cross-community bridge._
- **Why does `MarketContext` connect `Community 0` to `Community 64`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 41`, `Community 50`, `Community 63`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `create_app()` connect `Community 56` to `Community 42`, `Community 15`, `Community 20`, `Community 21`, `Community 55`, `Community 58`, `Community 59`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Are the 81 inferred relationships involving `StrategyProfile` (e.g. with `ConfluenceResult` and `CredentialStore`) actually correct?**
  _`StrategyProfile` has 81 INFERRED edges - model-reasoned connections that need verification._
