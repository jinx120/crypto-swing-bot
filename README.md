...
**New here?** The [**Trading Guide**](frontend/src/guide.md) walks you through filling out the
strategy form and starting the bot, with example configurations. It's also available in the
dashboard itself — click the **?** in the top-right nav.
